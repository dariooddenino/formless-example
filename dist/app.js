...
(function(exports) {
  ...
  var unRemoteField = function (v) {
      ...
      throw new Error("Failed pattern match at Validation line 39, column 1 - line 39, column 46: " + [ v.constructor.name ]);
  };

  // | Check that a username is inserted, and that it's made of letters only.
  var validUserName = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (f) {
          var s = unRemoteField(f);
          var $20 = Data_String_Common["null"](s);
          if ($20) {
              return new Data_Either.Left(Missing.value);
          };
          var $21 = Data_String_Regex.test(userNameRegex)(s);
          if ($21) {
  ...
  var toggleValidation = function (v) {
      ...
      throw new Error("Failed pattern match at Validation line 50, column 1 - line 50, column 61: " + [ v.constructor.name ]);
  };
  ...
  var validPhone = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $25 = Data_String_Regex.test(phoneRegex)(str);
          if ($25) {
  ...
  var nonEmpty = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $26 = Data_String_Common["null"](str);
          if ($26) {
              return new Data_Either.Left(Missing.value);
          };
          return new Data_Either.Right(str);
  ...
  var genericRemoteField = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Validation line 34, column 8 - line 34, column 64: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var errorToString = function (v) {
      ...
      throw new Error("Failed pattern match at Validation line 57, column 17 - line 64, column 1: " + [ v.constructor.name ]);
  };

  // | A function that renders an error if present.
  var showError = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Either.either(function ($57) {
      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(errorToString($57));
  ...
  var validEmail = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $52 = Data_String_Regex.test(emailRegex)(str);
          if ($52) {
              return new Data_Either.Right(str);
          };
  ...
  var acceptEmpty = function (dictMonad) {
      return function (validator) {
          return function (form) {
              return function (str) {
                  var $55 = Data_String_Common["null"](str);
                  if ($55) {
...
(function(exports) {
  ...
  var emailValidator = function (dictMonad) {
      ...
      return {
          userName: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(Validation.validUserName(Effect_Aff.monadAff))(Validation.availableUserName),

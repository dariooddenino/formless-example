  ...
  var set_ = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return function (i) {
                      return new Formless_Types_Component.Modify(Data_Newtype.wrap(dictNewtype)(Data_Variant.inj(dictCons)(dictIsSymbol)(sym)(Data_Newtype.wrap(Formless_Types_Form.newtypeInputFunction)(Data_Function["const"](i)))), Data_Unit.unit);
                  };
              };
          };
      };
...
(function(exports) {
  ...
  exports["eqRemoteData"] = eqRemoteData;
...
(function(exports) {
  ...
  var validUserName = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (v) {
          if (v instanceof Network_RemoteData.Success) {
              var $12 = Data_String_Common["null"](v.value0);
              if ($12) {
                  return new Data_Either.Left(Missing.value);
              };
              var $13 = Data_String_Regex.test(userNameRegex)(v.value0);
              if ($13) {
                  return new Data_Either.Right(new Network_RemoteData.Success(v.value0));
              };
  ...
  var validPhone = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $15 = Data_String_Regex.test(phoneRegex)(str);
          if ($15) {
  ...
  var nonEmpty = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $16 = Data_String_Common["null"](str);
          if ($16) {
              return new Data_Either.Left(Missing.value);
          };
          return new Data_Either.Right(str);
  ...
  var errorToString = function (v) {
      ...
      throw new Error("Failed pattern match at Validation line 37, column 17 - line 44, column 1: " + [ v.constructor.name ]);
  };

  // | A function that renders an error if present.
  var showError = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Either.either(function ($41) {
      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(errorToString($41));
  ...
  var validEmail = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $34 = Data_String_Regex.test(emailRegex)(str);
          if ($34) {
              return new Data_Either.Right(str);
          };
  ...
  var availableUserName = Formless_Validation.hoistFnME_(Effect_Aff.monadAff)(function (userName) {
      if (userName instanceof Network_RemoteData.Success) {
          return Control_Bind.bind(Effect_Aff.bindAff)(checkUserName(userName.value0))(function (v) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
                  if (v) {
                      return new Data_Either.Left(ExistingUserName.value);
                  };
                  return new Data_Either.Right(new Network_RemoteData.Success(userName.value0));
              })());
          });
      };
      return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Either.Right(userName));
  });
  ...
  var acceptEmpty = function (dictMonad) {
      return function (validator) {
          return function (form) {
              return function (str) {
                  var $39 = Data_String_Common["null"](str);
                  if ($39) {
...
(function(exports) {
  ...
  var renderError = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 112, column 1 - line 112, column 55: " + [ v.constructor.name ]);
  };
  ...
  var renderForm = function (v) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("label") ])([ Halogen_HTML_Core.text("User name") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("control") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_("input"), Halogen_HTML_Properties.required(true), Halogen_HTML_Properties.disabled(isloading(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
          ...
          return Formless_Query.set(new Data_Symbol.IsSymbol(function () {
              ...
              return "userName";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).userName)(Network_RemoteData.Success.create($20));
      })), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_((function () {
          var val = Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "userName";
          }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "userName";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).userName)(v.form);
          return Formless_Query.andThen(Formless_Query.set_(new Data_Symbol.IsSymbol(function () {
              return "userName";
          }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "userName";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).userName)(Network_RemoteData.Loading.value))(Formless_Query.setValidate_(new Data_Symbol.IsSymbol(function () {
              return "userName";
          }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "userName";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).userName)(val));
      })())) ]), renderError(Validation.showError(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
          return "userName";
      }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
  ...
  var emailValidator = function (dictMonad) {
          return Formless_Validation.Validation(function (form) {
              return function (email) {
                  var $16 = Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                      return "sendEmail";
                  }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "email";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
  ...
  var initialInputs = Formless_Transform_Record.wrapInputFields(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
      ...
      userName: new Network_RemoteData.Success(""),
      email: "",
      phone: "",
      sendEmail: false
  });
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot(Data_Unit.unit)(Formless_Component.component(Data_Ord.ordVoid)(Effect_Aff.monadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "userName";
          }))(Formless_Types_Form.eqInputField(Network_RemoteData.eqRemoteData(Data_Eq.eqUnit)(Data_Eq.eqString))))()(new Data_Symbol.IsSymbol(function () {
              return "sendEmail";

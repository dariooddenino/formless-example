              ...
              return function (dictCons) {
                  return function (dictCons1) {
                      return new MapRecordWithIndex(function (v) {
                          return function (f) {
                              return Control_Semigroupoid.compose(Record_Builder.semigroupoidBuilder)(Record_Builder.modify(dictCons)(dictCons1)(dictIsSymbol)(Data_Symbol.SProxy.value)(mappingWithIndex(dictMappingWithIndex)(f)(Data_Symbol.SProxy.value)))(mapRecordWithIndexBuilder(dictMapRecordWithIndex)(Type_Row.RLProxy.value)(f));
                          };
                      });
                  };
              };
...
(function(exports) {
  ...
  var hoistFnME_ = function (dictMonad) {
      return function ($50) {
          return Validation(Data_Function["const"]($50));
      };
  };
  ...
  var set = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return function (i) {
                      return Formless_Types_Component.Modify.create(Data_Newtype.wrap(dictNewtype)(Data_Variant.inj(dictCons)(dictIsSymbol)(sym)(Data_Newtype.wrap(Formless_Types_Form.newtypeInputFunction)(Data_Function["const"](i)))));
                  };
              };
          };
      };
  };                                                
  var modify_ = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return function (f) {
                      return new Formless_Types_Component.Modify(Data_Newtype.wrap(dictNewtype)(Data_Variant.inj(dictCons)(dictIsSymbol)(sym)(Data_Newtype.wrap(Formless_Types_Form.newtypeInputFunction)(f))), Data_Unit.unit);
                  };
              };
          };
      };
...
(function(exports) {
  ...
  var Validating = (function () {
      function Validating(value0) {
          this.value0 = value0;
      };
      Validating.create = function (value0) {
          return new Validating(value0);
      };
      return Validating;
  })();
  ...
  // | This is a wrapper data type we will use to represent
  // | validations in progress for async fields.
  var NotValidating = (function () {
      function NotValidating(value0) {
          this.value0 = value0;
      };
      NotValidating.create = function (value0) {
          return new NotValidating(value0);
      };
  ...
  var userNameRegex = unsafeRegexFromString("^([a-zA-Z]+)$");
  ...
  var validUserName = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (s) {
          var $27 = Data_String_Common["null"](s);
          if ($27) {
              return new Data_Either.Left(Missing.value);
          };
          var $28 = Data_String_Regex.test(userNameRegex)(s);
          if ($28) {
              return new Data_Either.Right(s);
          };
          return new Data_Either.Left(InvalidUserName.value);
      });
  };

  // | Just a function to extract the value.
  var unRemoteField = function (v) {
      if (v instanceof Validating) {
          return v.value0;
      };
      if (v instanceof NotValidating) {
          return v.value0;
      };
      throw new Error("Failed pattern match at Validation line 56, column 1 - line 56, column 46: " + [ v.constructor.name ]);
  };

  // | Toggles the validating status of a field.
  var toggleValidation = function (v) {
      if (v instanceof Validating) {
          return new NotValidating(v.value0);
      };
      if (v instanceof NotValidating) {
          return new Validating(v.value0);
      };
      throw new Error("Failed pattern match at Validation line 67, column 1 - line 67, column 61: " + [ v.constructor.name ]);
  };
  ...
  var validPhone = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $35 = Data_String_Regex.test(phoneRegex)(str);
          if ($35) {
  ...
  var nonEmpty = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $36 = Data_String_Common["null"](str);
          if ($36) {
              return new Data_Either.Left(Missing.value);
          };
          return new Data_Either.Right(str);
  ...
  var isValidating = function (v) {
      if (v instanceof Validating) {
          return true;
      };
      return false;
  };
  var genericRemoteField = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Validating) {
          return new Data_Generic_Rep.Inl(x.value0);
      };
      if (x instanceof NotValidating) {
          return new Data_Generic_Rep.Inr(x.value0);
      };
      throw new Error("Failed pattern match at Validation line 36, column 8 - line 36, column 64: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return new Validating(x.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr) {
          return new NotValidating(x.value0);
      };
      throw new Error("Failed pattern match at Validation line 36, column 8 - line 36, column 64: " + [ x.constructor.name ]);
  });       
  var functorRemoteField = new Data_Functor.Functor(function (f) {
      return function (v) {
          if (v instanceof Validating) {
              return Validating.create(f(v.value0));
          };
          if (v instanceof NotValidating) {
              return NotValidating.create(f(v.value0));
          };
          throw new Error("Failed pattern match at Validation line 39, column 1 - line 39, column 51: " + [ f.constructor.name, v.constructor.name ]);
      };
  });
  var foldableRemoteField = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function (v) {
              if (v instanceof NotValidating) {
                  return f(v.value0);
              ...
              throw new Error("Failed pattern match at Validation line 42, column 1 - line 42, column 53: " + [ f.constructor.name, v.constructor.name ]);
          };
      };
  }, function (f) {
      return function (z) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Validation line 42, column 1 - line 42, column 53: " + [ f.constructor.name, z.constructor.name, v.constructor.name ]);
          };
      };
  }, function (f) {
      return function (z) {
  ...
  var traversableRemoteField = new Data_Traversable.Traversable(function () {
      return foldableRemoteField;
  }, function () {
      return functorRemoteField;
  }, function (dictApplicative) {
      return function (v) {
          if (v instanceof Validating) {
              return Data_Functor.map((dictApplicative.Apply0()).Functor0())(Validating.create)(v.value0);
          };
          if (v instanceof NotValidating) {
              return Data_Functor.map((dictApplicative.Apply0()).Functor0())(NotValidating.create)(v.value0);
          };
          throw new Error("Failed pattern match at Validation line 49, column 1 - line 49, column 59: " + [ v.constructor.name ]);
      };
  }, function (dictApplicative) {
      return function (f) {
          return function (v) {
              if (v instanceof Validating) {
                  return Data_Functor.map((dictApplicative.Apply0()).Functor0())(Validating.create)(f(v.value0));
              };
              if (v instanceof NotValidating) {
                  return Data_Functor.map((dictApplicative.Apply0()).Functor0())(NotValidating.create)(f(v.value0));
              };
              throw new Error("Failed pattern match at Validation line 49, column 1 - line 49, column 59: " + [ f.constructor.name, v.constructor.name ]);
          };
      };
  });
  var overRemoteField = function (dictMonad) {
      return function (validator) {
          return function (form) {
              return function (i) {
                  return Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(Data_Traversable.sequence(traversableRemoteField)(Data_Either.applicativeEither))(Data_Traversable.traverse(traversableRemoteField)(dictMonad.Applicative0())(Formless_Validation.runValidation(dictMonad)(validator)(form))(i));
              };
          };
      };
  };
  ...
  var errorToString = function (v) {
      ...
      throw new Error("Failed pattern match at Validation line 74, column 17 - line 81, column 1: " + [ v.constructor.name ]);
  };

  // | A function that renders an error if present.
  var showError = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Either.either(function ($92) {
      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(errorToString($92));
  })(Data_Function["const"](Data_Maybe.Nothing.value)));
  var eqRemoteField = function (dictEq) {
      return new Data_Eq.Eq(Data_Generic_Rep_Eq.genericEq(genericRemoteField)(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqArgument(dictEq)))(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqArgument(dictEq)))));
  };
  ...
  var validEmail = function (dictMonad) {
      return Formless_Validation.hoistFnE_(dictMonad)(function (str) {
          var $87 = Data_String_Regex.test(emailRegex)(str);
          if ($87) {
              return new Data_Either.Right(str);
          };
  ...
  var checkUserName = function (u) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqString)(u)([ "admin", "formless", "user" ]));
      });
  };

  // | This functions performs a (fake) effectful check to verify that
  // | the userName is not already in use.
  var availableUserName = Formless_Validation.hoistFnME_(Effect_Aff.monadAff)(function (f) {
      var userName = unRemoteField(f);
      return Control_Bind.bind(Effect_Aff.bindAff)(checkUserName(userName))(function (v) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
              if (v) {
                  return new Data_Either.Left(ExistingUserName.value);
              };
              return new Data_Either.Right(userName);
          })());
      });
  });
  ...
  var acceptEmpty = function (dictMonad) {
      return function (validator) {
          return function (form) {
              return function (str) {
                  var $90 = Data_String_Common["null"](str);
                  if ($90) {
  ...
  exports["NotValidating"] = NotValidating;
  exports["unRemoteField"] = unRemoteField;
  ...
  exports["overRemoteField"] = overRemoteField;
  exports["validEmail"] = validEmail;
  exports["validPhone"] = validPhone;
  exports["acceptEmpty"] = acceptEmpty;
  exports["availableUserName"] = availableUserName;
  exports["checkUserName"] = checkUserName;
  exports["genericRemoteField"] = genericRemoteField;
  exports["eqRemoteField"] = eqRemoteField;
  exports["functorRemoteField"] = functorRemoteField;
  exports["foldableRemoteField"] = foldableRemoteField;
  exports["traversableRemoteField"] = traversableRemoteField;
...
(function(exports) {
  ...
  var renderError = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 127, column 1 - line 127, column 55: " + [ v.constructor.name ]);
  };
  ...
  var renderForm = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("label") ])([ Halogen_HTML_Core.text("User name") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("control") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_("input"), Halogen_HTML_Properties.required(true), Halogen_HTML_Properties.disabled(Validation.isValidating(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
          ...
          return "userName";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).userName)(v.form))), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function ($20) {
          return Formless_Query.set(new Data_Symbol.IsSymbol(function () {
              return "userName";
          }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "email";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "userName";
          }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).userName)(Validation.NotValidating.create($20));
      })), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(Formless_Query.andThen(Formless_Query.modify_(new Data_Symbol.IsSymbol(function () {
          return "userName";
      }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "userName";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).userName)(Validation.toggleValidation))(Formless_Query.modifyValidate_(new Data_Symbol.IsSymbol(function () {
          return "userName";
      }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "userName";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).userName)(Validation.toggleValidation)))) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("help") ])([ Halogen_HTML_Core.text("Try 'admin', 'formless' or 'user' to get an async error.") ]), renderError(Validation.showError(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
          return "userName";
      }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "userName";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).email))) ]), renderError(Validation.showError(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "userName";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).phone))) ]), renderError(Validation.showError(Formless_Retrieve.getResult(new Data_Symbol.IsSymbol(function () {
          return "phone";
      }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
      ...
      })) ]), Halogen_HTML_Core.text("Send me spam emails") ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("button"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Types_Component.Submit.create)) ])([ Halogen_HTML_Core.text("Submit") ]) ]);
  };
  ...
  var emailValidator = function (dictMonad) {
          return Formless_Validation.Validation(function (form) {
              return function (email) {
                  var $14 = Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                      return "sendEmail";
                  }))(newtypeForm)()((prx()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "email";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "userName";
                  }))(Formless_Transform_Internal.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))))).sendEmail)(form);
                  if ($14) {
                      return Formless_Validation.runValidation(dictMonad)(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(Validation.nonEmpty(dictMonad))(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(Validation.validEmail(dictMonad))(Formless_Validation.hoistFn_(dictMonad)(Data_Maybe.Just.create))))(form)(email);
                  };
                  return Formless_Validation.runValidation(dictMonad)(Validation.acceptEmpty(dictMonad)(Validation.validEmail(dictMonad)))(form)(email);
              };
          });
      };
      return {
          userName: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(Validation.overRemoteField(Effect_Aff.monadAff)(Validation.validUserName(Effect_Aff.monadAff)))(Validation.availableUserName),
          email: emailValidator(Effect_Aff.monadAff),
  ...
  var initialInputs = Formless_Transform_Record.wrapInputFields(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
      return "email";
      ...
      userName: new Validation.NotValidating(""),
      email: "",
      phone: "",
      sendEmail: false
  });
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot(Data_Unit.unit)(Formless_Component.component(Data_Ord.ordVoid)(Effect_Aff.monadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "userName";
          }))(Formless_Types_Form.eqInputField(Validation.eqRemoteField(Data_Eq.eqString))))()(new Data_Symbol.IsSymbol(function () {
              return "sendEmail";
      ...
      // State == Input
  var initialState = Control_Category.identity;
      var $$eval = function (v) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
              if (v.value0 instanceof Formless_Types_Component.Submitted) {
                  var form = Formless_Transform_Record.unwrapOutputFields(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                      return "email";
                      ...
                      return "userName";
                  }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()())()()))(v.value0.value0);
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Class_Console.logShow(Effect_Class.monadEffectEffect)(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "email";
                      ...
                      return "userName";
                  }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showBoolean))(Data_Show.showString))(Data_Maybe.showMaybe(Data_Show.showString))))(form));
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          })());
      };
      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
          initialState: initialState(Control_Category.categoryFn),
          render: render,
          "eval": $$eval,
